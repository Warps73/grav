...
return [
    ...
    'timestamp' => 1543493894,
    'checksum' => 'e8a987e8ea2dbaff7578d5c69cc34efa',
    'files' => [
        ...
        'user/plugins' => [
            ...
            'plugins/form-database' => [
                'file' => 'user/plugins/form-database/blueprints.yaml',
                'modified' => 1543493651
            ],
            'plugins/login' => [
    ...
    'data' => [
        'items' => [
            ...
            'plugins.form-database.enabled' => [
                ...
                'name' => 'plugins.form-database.enabled',
                'validation' => 'strict'
            ],
            'plugins.form-database.mysql_server' => [
                'type' => 'text',
                'label' => 'MySQL Servername',
                'name' => 'plugins.form-database.mysql_server',
                'validation' => 'strict'
            ],
            'plugins.form-database.mysql_port' => [
                'type' => 'text',
                'size' => 'x-small',
                'label' => 'MySQL Server Port',
                'default' => '3306',
                'name' => 'plugins.form-database.mysql_port',
                'validation' => 'strict'
            ],
            'plugins.form-database.mysql_username' => [
                'type' => 'text',
                'label' => 'MySQL Username',
                'name' => 'plugins.form-database.mysql_username',
                'validation' => 'strict'
            ],
            'plugins.form-database.mysql_password' => [
                'type' => 'password',
                'label' => 'MySQL Password',
                'name' => 'plugins.form-database.mysql_password',
                'validation' => 'strict'
            ],
            'plugins.login' => [
                'type' => '_root',
        ...
        'nested' => [
            ...
            'plugins' => [
                ...
                'form-database' => [
                    'enabled' => 'plugins.form-database.enabled',
                    'mysql_server' => 'plugins.form-database.mysql_server',
                    'mysql_port' => 'plugins.form-database.mysql_port',
                    'mysql_username' => 'plugins.form-database.mysql_username',
                    'mysql_password' => 'plugins.form-database.mysql_password'
                ],
                'login' => [
